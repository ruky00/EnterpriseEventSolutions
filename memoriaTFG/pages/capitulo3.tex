...
En resumen, la adopción de la metodología Scrum\tutor{Es la segunda vez en esta sección que empiezas una frase con ``En resumen, la adopción de la metodología Scrum''. Revisa el contenido de nuevo}, con su enfoque en pequeños objetivos semanales y el uso de un tablero Trello para la gestión de tareas, 
