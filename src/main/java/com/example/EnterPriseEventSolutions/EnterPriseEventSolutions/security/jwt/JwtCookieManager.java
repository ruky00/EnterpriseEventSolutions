package com.example.EnterPriseEventSolutions.EnterPriseEventSolutions.security.jwt;
...
public class JwtCookieManager {
	...
	public HttpCookie deleteAccessTokenCookie() {
		return ResponseCookie.from(ACCESS_TOKEN_COOKIE_NAME, "").maxAge(0).httpOnly(false).path("/").secure(true).sameSite("NONE").build();
	}
